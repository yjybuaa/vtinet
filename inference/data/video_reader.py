...
class VideoReader(Dataset):
    ...
    """
    def __init__(self, vid_name, image_dir, ir_dir, mask_dir, size=-1, to_save=None, use_all_mask=False, size_dir=None):
        """
        ...
        self.irs = sorted(os.listdir(self.ir_dir))
    ...
    def __getitem__(self, idx):
        ...
        ir_path = path.join(self.ir_dir, ir)

        img = Image.open(im_path).convert('RGB')
        thermal = Image.open(ir_path).convert('RGB')
        ...
        thermal = self.im_transform(thermal)
